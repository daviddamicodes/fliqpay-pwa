    ...
    <div className="bg-gray-bg h-screen pt-14 border-gray-1 border-2">
      <div className="bg-white max-w-470 rounded-lg px-6 py-8 mx-auto">
        <div className="font-semibold text-md mb-8 pb-2 border-b-2 border-gray-1 text-purple-900">
          ...
          <h4 className="text-xs text-purple-700 text-opacity-70">
        ...
        <div className="flex flex-col mb-4">
          <label
            htmlFor="email"
            className="pointer-events-none text-xs text-gray-500 mb-1"
          >
          ...
          <input
            ...
            required
            className=" w-5/5 px-3.5 py-3 text-sm rounded-lg focus:outline-none border-gray-1 border-2 text-purple-900 appearance-none"
            autoComplete="off"
            placeholder=""
          />
        </div>
        ...
        <h4 className="font-semibold text-sm pb-3 mb-2 border-b-2 border-gray-1 text-purple-900">
          Bank details
        </h4>
        <div className="flex flex-col mb-4">
          <div className="flex mb-6">
            <button
              ...
              className={
                toggle
                  ? "text-xs font-semibold text-purple-900 bg-white px-3 py-3 border-b-2 border-purple-900 transition-all duration-200"
                  : "text-xs font-normal text-gray-700 bg-white px-3 py-3 transition-all duration-200"
              }
